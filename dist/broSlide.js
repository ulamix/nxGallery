...
(function (window, document, location, $, undefined) {
  ...
  jQuery.Fotorama = function ($fotorama, opts) {
    ...
    function frameDraw(indexes, type) {
      eachIndex(indexes, type, function (i, index, dataFrame, $frame, key, frameData) {
        ...
        if (type === 'stage') {
          ...
          if (dataFrame.html) {
            $('<div class="' + htmlClass + '"></div>').append(dataFrame._html ? $(dataFrame.html).removeAttr('id').html(dataFrame._html) // Because of IE
    ...
    function thumbsDraw(pos, loadFLAG) {
      ...
      $navThumbFrame.each(function () {
        var $this = $(this),
            thisData = $this.data(),
            eq = thisData.eq,
            getSpecialMeasures = function getSpecialMeasures() {
          return {
            h: o_thumbSide2,
            w: thisData.w
          };
    ...
    that.playVideo = function () {
      ...
      if ((typeof video === 'undefined' ? 'undefined' : _typeof(video)) === 'object' && dataFrame.videoReady) {
    ...
    stageShaftTouchTail = moveOnTouch($stageShaft, {
      ...
      onMove: function onMove(e, result) {
    ...
    stageWheelTail = wheel($stage, {
      shift: true,
      onEnd: function onEnd(e, direction) {
    ...
    $.each('load push pop shift unshift reverse sort splice'.split(' '), function (i, method) {
      that[method] = function () {
        ...
        } else if (arguments[0] && _typeof(arguments[0]) === 'object' && arguments[0].length) {
